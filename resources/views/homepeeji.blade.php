...
<head>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="{{asset('assets/majapahit/css/bootstrap.css')}}" />

  <link href="https://fonts.googleapis.com/css?family=Poppins:400,700&display=swap" rel="stylesheet">
  <!-- Custom styles for this template -->
  <link href="{{asset('assets/majapahit/css/style.css')}}" rel="stylesheet" />
  <!-- responsive style -->
  <link href="{{asset('assets/majapahit/css/responsive.css')}}" rel="stylesheet" />
</head>
...
<body>
      ...
      <div class="container-fluid">
        <nav class="navbar navbar-expand-lg custom_nav-container">
          <a class="navbar-brand" href="index.html">
            <img src="{{asset('assets/majapahit/images/logo.png')}}" alt="" />
            <span>
              Perpusda Jatilawang
            </span>
          </a>
  ...
  <script src="{{asset('assets/majapahit/js/jquery-3.4.1.min.js ')}}"></script>
  <script src="{{asset('assets/majapahit/js/jquery-3.4.1.min.js ')}}"></script>
  <script src="{{asset('assets/majapahit/js/jquery-3.4.1.min.js ')}}"></script>
