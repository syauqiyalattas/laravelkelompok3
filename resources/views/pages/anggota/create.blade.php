...
<form action="{{ route('anggota.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group p-3">
        ...
        <input type="text" name='nomor_identifikasi' class="form-control" placeholder="Masukan Nomor Identifikasi">
    ...
    <div class="form-group p-3">
        ...
        <input type="text" name='nomor_telepon' class="form-control" placeholder="Masukan Nomor Telepon">
        @error('nomor_telepon')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
